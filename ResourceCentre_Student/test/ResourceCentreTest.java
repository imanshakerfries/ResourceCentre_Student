...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		// Test that given an empty list, after adding one item, the size of the list is
		// 1
		ResourceCentre.addChromebook(chromebookList, cb1);
		assertEquals("Test if Chromebook arraylist size is 1", 1, chromebookList.size());

		// Test that given an empty list, after adding one item, the item just added is
		// as the same as the first item of the list
